...
from swing_trader.observability.metrics import RAG_CHUNKS_RETRIEVED, RAG_CHUNKS_USED, RAG_EMPTY_BLOCK_TOTAL
...
async def rag_retrieval_node(state: PipelineState) -> PipelineState:
    ...
    if block.chunks_used == 0:
        ...
        warnings.append("rag_retrieval: no relevant chunks found — reasoning will rely on structured data only")
